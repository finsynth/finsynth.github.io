...
/* `ms` is how long the claim holds the stage, and it is set from its visual's
   ...
   The audit cascade is the constraint — its loop runs three beats over 9s (one
   per source; see the .xvk-* keyframes in index.css), and at the 4.2s every claim used to
