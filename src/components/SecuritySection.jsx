        ...
        <div className="sec-table">
          <div className="sec-row">
            <div className="sec-cell">
              ...
              <p className="body-text">Describe the analysis in plain English and FinSynth assembles a fully structured model with schedules, drivers, and formulas, ready to audit.</p>
            </div>
            <div className="sec-cell">
              <svg className="lineic" viewBox="0 0 44 44" fill="none" stroke="currentColor" strokeWidth="1.4">
